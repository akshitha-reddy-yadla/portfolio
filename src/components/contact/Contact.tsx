...
const Contact = () => {
  ...
  return (
    <div className="text-center mt-24 lg:mt-12 md:pt-20">
      <div className="w-80 h-auto md:w-96 lg:w-1/2 md:py-8 my-8 mx-auto">
        <p>
          <span className="text-green-500" id="sent">&nbsp;</span>
          <span className="text-red-900" id="error">&nbsp;</span>
        </p>
        <form className="flex flex-col justify-center items-center w-3/4 md:w-full md:px-8 lg:px-12 mx-auto my-4" onSubmit={validateForm}>
